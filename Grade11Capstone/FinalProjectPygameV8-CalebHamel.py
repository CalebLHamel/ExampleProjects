...
# The game will force the width to be greater than the height, otherwise many textures would break.
...
width, height = 1000, 600 #Defines the width and height of the screen.
...
screen_size = width, height = math.floor(width * screen_size_multiplier), math.floor(height * screen_size_multiplier)
...
difficulty_button_size = ((max_grid_size * .15, max_grid_size * .15))
...
start_button = pygame.transform.scale(start_button, (max_grid_size * .2, max_grid_size * .12))
...
game_won_screen = pygame.transform.scale(game_won_screen, (max_grid_size, height * .1))

game_lost_screen = pygame.image.load("game_over_screen/user_lost_screen.png")
game_lost_screen = pygame.transform.scale(game_lost_screen, (max_grid_size, height * .1))

play_again_button = pygame.image.load("game_over_screen/play_again_button.png")
play_again_button = pygame.transform.scale(play_again_button, (max_grid_size * .2, max_grid_size * .1))

quit_game_button = pygame.image.load("game_over_screen/quit_game_button.png")
quit_game_button = pygame.transform.scale(quit_game_button, (max_grid_size * .2, max_grid_size * .1))
...
def game_end():
    ...
    local_game_end_rect = game_end_rect.move((width / 2) - (game_end_rect[2] / 2) , 20 * screen_size_multiplier)
    
    #Display the appropiate image depending on whether the user won or lost.
    if game_over == True:
...
def start_menu(difficulty):
    ...
    start_menu_graphics(difficulty)
    ...
    #Used to determine how far the difficulty_buttons move.
    button_spacing = 20 * screen_size_multiplier
    difficulty_button_width = easy_difficulty_button_rect[3]
