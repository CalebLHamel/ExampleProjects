...
max_grid_size = 700 #Maximum size of the grid 
...
def update_screen():
    ...
    for tile in tile_list: #For each tile.
        ...
        if tile[3] == "mine" and game_over == True:
...
def game_end():
    ...
    local_game_end_rect = game_end_rect.move((960 / 2) - (game_end_rect[2] / 2) , 20)
    ...
    local_play_again_button_rect = game_end_button_rect.move(500, 45)
    screen.blit(play_again_button, local_play_again_button_rect)
    local_quit_button_rect = game_end_button_rect.move(600, 45)
...
def start_menu():
    ...
    new_tile_origin_x = (960 / 2) - (max_grid_size / 2)
    new_tile_origin_y = (960 / 2) - (max_grid_size / 2)
...
while True:
    ...
    game_variables = start_menu() #Start menu and setting variable values.
